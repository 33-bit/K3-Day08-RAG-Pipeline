...
### 🔹 Checkpoint 5: Bài Tập Nhóm — Chatbot UI & Đánh Giá RAGAS (2:00 – 2:30 | 30 phút)
...
* 🎤 **Review & Call-out (2:30 – 2:40 | 10 phút)**: Các nhóm kiểm tra lại ứng dụng Streamlit live demo lần cuối & chuẩn bị nội dung thuyết trình sản phẩm.

---

### 🔹 Checkpoint 6: Thuyết Trình Demo Live & Nộp Bài (2:40 – 4:00 | 80 phút = 1h 20m)
...
* ✅ **Tiêu chí hoàn thành (Pass Criteria)**: Tất cả các nhóm hoàn tất thuyết trình live demo (80 phút) và cập nhật toàn bộ mã nguồn lên repository GitHub của nhóm (`CP6 Passed`).
